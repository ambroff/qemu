...
meson_options_help() {
  ...
  printf "%s\n" '  --enable-deterministic   build with deterministic execution support'
...
_meson_option_parse() {
  case $1 in
    ...
    --enable-deterministic) printf "%s" -Ddeterministic=true ;;
    --disable-deterministic) printf "%s" -Ddeterministic=false ;;
